...
public class MockServiceTest {
    ...
    @Test
    public void shouldOneTimeRunForChampionArrayName(){
        Champion champion = mock(Champion.class);
        champion.setName("조이");
        champion.setPosition("미드");
        champion.setHasSkinCount(3);
    ...
    @Test
    public void shouldPassWhenNeverRunChampionSetName_2() {
        Champion champion = mock(Champion.class);
    //    champion.setName("조이");
        champion.setPosition("미드");
        champion.setHasSkinCount(3);
    ...
    @Test
    public void 챔피언객체에서이름을가져오는로직이200ms시간이내에1번실행되는지확인(){
        Champion champion = mock(Champion.class);
        champion.setName("조이");
        champion.setName("이즈리얼");
        champion.setPosition("미드");
        champion.setHasSkinCount(3);
    ...
    public void 챔피언정보들을Mocking하고Service메소드호출테스트() {
        ...
        System.out.println("cham name : " + championName);
    ...
    @Test
    public void 리산드라를검색하면미드포지션과가짜객체를리턴하고탑이맞는지를테스트(){
    ...
    @Test
    public void 두개이상의챔피언을리스트로만들어전체챔피언을가져오는메소드호출시갯수가맞는지확인(){
        List<Champion> champions = new ArrayList<>();
        champions.add(new Champion("이즈리얼", "미드", 3));
        champions.add(new Champion("티모", "탑", 4));
        champions.add(new Champion("애쉬", "정글", 5));
    ...
    @Test
    public void 챔피언검색시가짜챔피언객체를리턴하고mockRepository의해당메소드가1번호출되었는지검증테스트(){
